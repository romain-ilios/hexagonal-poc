...
var TodoStore = class {
  constructor() {
     ...
     */
    this.todos$ = new rxjs.BehaviorSubject([]);
    /**
...
function useTodos() {
  const [todos, setTodos] = react.useState(todoStore.getTodosSnapshot());
...
function useTodos2() {
  const todos = vue.ref(todoStore.getTodosSnapshot());
  const isLoading = vue.ref(todoStore.getIsLoadingSnapshot());
  const error = vue.ref(todoStore.getErrorSnapshot());
...
exports.todoService = todoService;
exports.todoStore = todoStore;
exports.useTodosReact = useTodos;
exports.useTodosVue = useTodos2;
